...
try:
            ...
            if production_versions:
                ...
                try:
                    ...
                    if "validation_rmse" in prod_tags:
                        ...
                        print("⚠️  No validation_rmse tag found in production model - promoting anyway")
    ...
    model_metadata = {
        ...
        "model_uri": f"models:/{model_name}/{final_stage}" if final_stage != "None" else f"models:/{model_name}/{version_number}"
    }
