...
# __4. GRadient Boosting Regressor Model:__
...
with mlflow.start_run(run_name="Gradient-Boosting-regression-corn-yield"):
    ...
    metrics = evaluate_model(y_val, y_pred_val, "Gradient Boosting Regressor")
